...
description: |
  Generate images or videos with the Higgsfield CLI, including Marketing
  Studio ads. Use when the user asks to make, edit, stylize, or animate
  visuals, create UGC/ad/product-demo video, or use avatars/products. Not for
  Soul training, product photoshoots, marketplace cards, chat, or TTS.
allowed-tools: Bash
---
